namespace _2DEngine.Game
{
	public sealed class BoxCollider : Collider
	{
		...
		{
			Matrix4x4 boxMatrix = Matrix4x4.CreateWorldMatrix(new Vector3(size.x, 0f, 0f), new Vector3(0f, size.y, 0f), Vector3.forward, center) * transform.localToWorld;
			...
			Debug.DrawBox(boxMatrix.GetInversed(), Color32.red);
